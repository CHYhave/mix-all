...
import org.ajhy.notify.publisher.*;
import org.ajhy.spi.ServiceLoader;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.ajhy.annotation.JustForTest;
import org.ajhy.exception.NotifyCenterException;
import org.ajhy.notify.subscriber.SmartSubscriber;
import org.ajhy.notify.subscriber.Subscriber;
import org.ajhy.util.ClassUtils;
import org.ajhy.util.MapUtil;
...
public class NotifyCenter {
    ...
    public static final int ringBufferSize;
    public static final int shareBufferSize;
    ...
    static {
        ...
        final Collection<EventPublisher> publishers = ServiceLoader.load(EventPublisher.class);
        ...
        DEFAULT_PUBLISHER_FACTORY = (cls, buffer) -> {
            try {
                ...
                throw new NotifyCenterException(ex);
            }
        };
